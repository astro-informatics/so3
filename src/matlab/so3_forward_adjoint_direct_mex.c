 ...
 * Usage:
 *   [f] = ...
 *     so3_forward_adjoint_direct_mex(flmn, L0, L, N, order, storage, n_mode, dl_method, reality, sampling_scheme);
 *
                   ...
                   int nrhs, const mxArray *prhs[])
{
    ...
    if (nrhs != 10)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:nrhs",
                          "Require ten inputs.");
    if (nlhs != 1)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidOutput:nlhs",
                          "Require one output.");

    /* Parse reality. */
    iin = 8;
    if( !mxIsLogicalScalar(prhs[iin]) )
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:reality",
    ...
    if (flmn_m != 1 && flmn_n != 1)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:flmnVector",
    ...
    if (!mxIsDouble(prhs[iin]) ||
        ...
        mxGetNumberOfElements(prhs[iin])!=1)
    {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:harmonicBandLimit",
    ...
    if (mxGetScalar(prhs[iin]) > (double)L ||
        L <= 0)
    {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:harmonicBandLimitNonInt",
    ...
    if (!mxIsDouble(prhs[iin]) ||
        ...
        mxGetNumberOfElements(prhs[iin])!=1)
    {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:orientationalBandLimit",
    ...
    if (mxGetScalar(prhs[iin]) > (double)N ||
        N <= 0)
    {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:orientationalBandLimitNonInt",
    ...
    if( !mxIsChar(prhs[iin]) ) {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:orderChar",
                          "Storage order must be string.");
    }
    len = (mxGetM(prhs[iin]) * mxGetN(prhs[iin])) + 1;
    if (len >= SO3_STRING_LEN)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:orderTooLong",
    ...
    iin = 5;
    if( !mxIsChar(prhs[iin]) ) {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:storageChar",
                          "Storage type must be string.");
    }
    len = (mxGetM(prhs[iin]) * mxGetN(prhs[iin])) + 1;
    if (len >= SO3_STRING_LEN)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:storageTooLong",
    ...
    if (strcmp(storage_str, SO3_STORAGE_PADDED_STR) == 0)
    {
        ...
        if ((reality && flmn_size != N*L*L)
            ...
            mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:flmnSize",
    ...
    else if (strcmp(storage_str, SO3_STORAGE_COMPACT_STR) == 0)
    {
        ...
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:storage",
    ...
    if (strcmp(order_str, SO3_N_ORDER_ZERO_FIRST_STR) == 0)
        ...
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:order",
                          "Invalid storage order.");

    /* Parse n-mode. */
    iin = 6;
    if( !mxIsChar(prhs[iin]) ) {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:nModeChar",
                          "Storage type must be string.");
    }
    len = (mxGetM(prhs[iin]) * mxGetN(prhs[iin])) + 1;
    if (len >= SO3_STRING_LEN)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:nModeTooLong",
    ...
    if (strcmp(n_mode_str, SO3_N_MODE_ALL_STR) == 0)
        ...
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:nMode",
                          "Invalid n-mode.");

    /* Parse Wigner recursion method. */
    iin = 7;
    if( !mxIsChar(prhs[iin]) ) {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:dlMethodChar",
                          "Wigner recursion method must be string.");
    }
    len = (mxGetM(prhs[iin]) * mxGetN(prhs[iin])) + 1;
    if (len >= SO3_STRING_LEN)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:dlMethodTooLong",
    ...
    iin = 9;
    if( !mxIsChar(prhs[iin]) ) {
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:samplingSchemeChar",
                          "Sampling scheme must be string.");
    }
    len = (mxGetM(prhs[iin]) * mxGetN(prhs[iin])) + 1;
    if (len >= SO3_STRING_LEN)
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:samplingSchemeTooLong",
    ...
    else if (strcmp(sampling_str, SO3_SAMPLING_MW_SS_STR) == 0)
    {
        ...
        mexErrMsgIdAndTxt("so3_forward_adjoint_direct_mex:InvalidInput:samplingScheme",
