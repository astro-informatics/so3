...
double so3_sampling_mw_t2theta(int t, int L) {
  ...
  return (2.0*t + 1.0) * SO3_PI / (2.0*L - 1.0);
 ...
 * \author <a href="http://www.jasonmcewen.org">Jason McEwen</a>
 */
inline void so3_sampling_elm2ind(int *ind, int el, int m) {
 ...
 * \author <a href="http://www.jasonmcewen.org">Jason McEwen</a>
 */
inline void so3_sampling_ind2elm(int *el, int *m, int ind) {
